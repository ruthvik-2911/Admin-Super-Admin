...
export const DetailDrawer: React.FC<DetailDrawerProps> = ({ 
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 lg:p-8">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-2xl max-h-[90vh] bg-white dark:bg-[#1A1D24] rounded-[2.5rem] shadow-2xl flex flex-col overflow-hidden animate-fade-in-scale border border-gray-100 dark:border-gray-800 transition-colors">
        {/* Header */}
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto w-full max-w-full bg-gray-50 dark:bg-[#0E1117] transition-colors relative flex flex-col">
          {children}
        </div>
      </div>
    </div>,
