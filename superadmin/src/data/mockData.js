...
const generateHourlyData = (totalClicks, totalImpressions) => {
  return Array.from({ length: 24 }, (_, i) => ({
    hour: i,
    clicks: Math.floor(Math.random() * (totalClicks / 10)),
    impressions: Math.floor(Math.random() * (totalImpressions / 10))
  }));
};

export const mockAds = [
  { id: 'AD001', title: 'Summer Sale Blast', type: 'Banner', adminId: 'ADM001', adminName: 'Rahul Sharma', publisherId: 'PUB001', publisherName: 'City Mall Display', city: 'Mumbai', radius: 5, status: 'Active', impressions: 12500, clicks: 450, revenue: 4500, date: '2026-04-12', hourlyBreakdown: generateHourlyData(450, 12500) },
  { id: 'AD002', title: 'New Car Launch', type: 'Video', adminId: 'ADM001', adminName: 'Rahul Sharma', publisherId: 'PUB002', publisherName: 'Metro Station Screens', city: 'Delhi', radius: 10, status: 'Active', impressions: 45000, clicks: 1800, revenue: 12000, date: '2026-04-10', hourlyBreakdown: generateHourlyData(1800, 45000) },
  { id: 'AD003', title: 'Pizza Buy 1 Get 1', type: 'Thumbnail', adminId: 'ADM004', adminName: 'Sneha Gupta', publisherId: 'PUB003', publisherName: 'Cafe Coffee Day - CP', city: 'Delhi', radius: 1, status: 'Expired', impressions: 8500, clicks: 250, revenue: 2100, date: '2026-03-15', hourlyBreakdown: generateHourlyData(250, 8500) },
  { id: 'AD004', title: 'Luxury watch Promo', type: 'Banner', adminId: 'ADM007', adminName: 'Karan Mehra', publisherId: 'PUB004', publisherName: 'PVR Cinemas Juhu', city: 'Mumbai', radius: 2, status: 'Active', impressions: 22000, clicks: 660, revenue: 8800, date: '2026-04-11', hourlyBreakdown: generateHourlyData(660, 22000) },
  { id: 'AD005', title: 'Health Checkup Pack', type: 'Video', adminId: 'ADM008', adminName: 'Neha Reddy', publisherId: 'PUB005', publisherName: 'Apollo Hospital Lobby', city: 'Bangalore', radius: 1, status: 'Active', impressions: 15000, clicks: 300, revenue: 3500, date: '2026-04-05', hourlyBreakdown: generateHourlyData(300, 15000) },
  { id: 'AD006', title: 'App Install Campaign', type: 'Thumbnail', adminId: 'ADM011', adminName: 'Arjun Malhotra', publisherId: 'PUB006', publisherName: 'IT Park Food Court', city: 'Pune', radius: 5, status: 'Suspended', impressions: 50000, clicks: 2500, revenue: 15000, date: '2026-04-01', hourlyBreakdown: generateHourlyData(2500, 50000) },
  { id: 'AD007', title: 'Realty Project Launch', type: 'Banner', adminId: 'ADM013', adminName: 'Sameer Joshi', publisherId: 'PUB007', publisherName: 'DLF Cyber Hub Screen', city: 'Gurgaon', radius: 10, status: 'Draft', impressions: 0, clicks: 0, revenue: 0, date: '2026-04-14', hourlyBreakdown: generateHourlyData(0, 0) },
  { id: 'AD008', title: 'Airline Early Bird', type: 'Video', adminId: 'ADM015', adminName: 'Manish Pandey', publisherId: 'PUB008', publisherName: 'Airport T3 Arrival', city: 'Delhi', radius: 10, status: 'Active', impressions: 120000, clicks: 4800, revenue: 35000, date: '2026-03-20', hourlyBreakdown: generateHourlyData(4800, 120000) },
  { id: 'AD009', title: 'Fashion Week Tickets', type: 'Thumbnail', adminId: 'ADM016', adminName: 'Tanvi Shah', publisherId: 'PUB009', publisherName: 'Phoenix Marketcity', city: 'Chennai', radius: 5, status: 'Active', impressions: 35000, clicks: 1400, revenue: 11000, date: '2026-04-13', hourlyBreakdown: generateHourlyData(1400, 35000) },
  { id: 'AD010', title: 'Watersports Pack', type: 'Banner', adminId: 'ADM019', adminName: 'Deepak Kumar', publisherId: 'PUB010', publisherName: 'Goa Beach Resort', city: 'Goa', radius: 5, status: 'Active', impressions: 9000, clicks: 450, revenue: 2700, date: '2026-04-08', hourlyBreakdown: generateHourlyData(450, 9000) },
  { id: 'AD011', title: 'Gym Membership Sale', type: 'Banner', adminId: 'ADM001', adminName: 'Rahul Sharma', publisherId: 'PUB011', publisherName: 'Luxury Gym Chain', city: 'Mumbai', radius: 5, status: 'Active', impressions: 18000, clicks: 900, revenue: 5400, date: '2026-04-01', hourlyBreakdown: generateHourlyData(900, 18000) },
  { id: 'AD012', title: 'Tech Gadget Launch', type: 'Video', adminId: 'ADM004', adminName: 'Sneha Gupta', publisherId: 'PUB012', publisherName: 'High Street Retails', city: 'Delhi', radius: 2, status: 'Expired', impressions: 65000, clicks: 1950, revenue: 18500, date: '2026-02-10', hourlyBreakdown: generateHourlyData(1950, 65000) },
  { id: 'AD013', title: 'Software Discount', type: 'Thumbnail', adminId: 'ADM011', adminName: 'Arjun Malhotra', publisherId: 'PUB006', publisherName: 'IT Park Food Court', city: 'Pune', radius: 5, status: 'Active', impressions: 22000, clicks: 1100, revenue: 6000, date: '2026-04-11', hourlyBreakdown: generateHourlyData(1100, 22000) },
  { id: 'AD014', title: 'Organic Grocery Promo', type: 'Banner', adminId: 'ADM015', adminName: 'Manish Pandey', publisherId: 'PUB017', publisherName: 'Apartment Lift Panels', city: 'Noida', radius: 1, status: 'Active', impressions: 45000, clicks: 1350, revenue: 9000, date: '2026-03-25', hourlyBreakdown: generateHourlyData(1350, 45000) },
  { id: 'AD015', title: 'Cloud Services Ad', type: 'Video', adminId: 'ADM016', adminName: 'Tanvi Shah', publisherId: 'PUB018', publisherName: 'Tech Park Entrance', city: 'Bangalore', radius: 5, status: 'Active', impressions: 85000, clicks: 3400, revenue: 22000, date: '2026-04-09', hourlyBreakdown: generateHourlyData(3400, 85000) },
  { id: 'AD016', title: 'Music Fest Early Access', type: 'Thumbnail', adminId: 'ADM001', adminName: 'Rahul Sharma', publisherId: 'PUB020', publisherName: 'HyperCity Lobby', city: 'Mumbai', radius: 5, status: 'Draft', impressions: 0, clicks: 0, revenue: 0, date: '2026-04-14', hourlyBreakdown: generateHourlyData(0, 0) },
  { id: 'AD017', title: 'Spa & Wellness Expo', type: 'Banner', adminId: 'ADM004', adminName: 'Sneha Gupta', publisherId: 'PUB021', publisherName: 'Luxury Spa & Salon', city: 'Delhi', radius: 2, status: 'Active', impressions: 5000, clicks: 250, revenue: 1800, date: '2026-04-12', hourlyBreakdown: generateHourlyData(250, 5000) },
  { id: 'AD018', title: 'Heritage Tour Promo', type: 'Video', adminId: 'ADM007', adminName: 'Karan Mehra', publisherId: 'PUB022', publisherName: 'Convention Center', city: 'Jaipur', radius: 5, status: 'Active', impressions: 22000, clicks: 660, revenue: 6000, date: '2026-03-01', hourlyBreakdown: generateHourlyData(660, 22000) },
  { id: 'AD019', title: 'E-Learning Course Sale', type: 'Thumbnail', adminId: 'ADM011', adminName: 'Arjun Malhotra', publisherId: 'PUB023', publisherName: 'University Cafeteria', city: 'Chandigarh', radius: 5, status: 'Active', impressions: 18000, clicks: 900, revenue: 4500, date: '2026-04-10', hourlyBreakdown: generateHourlyData(900, 18000) },
  { id: 'AD020', title: 'IPL Final Tickets', type: 'Banner', adminId: 'ADM015', adminName: 'Manish Pandey', publisherId: 'PUB024', publisherName: 'Sports Stadium VIP', city: 'Mumbai', radius: 10, status: 'Active', impressions: 55000, clicks: 2750, revenue: 25000, date: '2026-04-14', hourlyBreakdown: generateHourlyData(2750, 55000) },
  { id: 'AD021', title: 'Wedding Photography', type: 'Video', adminId: 'ADM019', adminName: 'Deepak Kumar', publisherId: 'PUB025', publisherName: 'Boutique Hotel Lobby', city: 'Udaipur', radius: 5, status: 'Active', impressions: 12000, clicks: 600, revenue: 5000, date: '2026-04-05', hourlyBreakdown: generateHourlyData(600, 12000) },
  { id: 'AD022', title: 'Juice Bar Grand Opening', type: 'Thumbnail', adminId: 'ADM001', adminName: 'Rahul Sharma', publisherId: 'PUB001', publisherName: 'City Mall Display', city: 'Mumbai', radius: 2, status: 'Expired', impressions: 15000, clicks: 450, revenue: 2500, date: '2026-02-15', hourlyBreakdown: generateHourlyData(450, 15000) },
  { id: 'AD023', title: 'Real Estate Summit', type: 'Banner', adminId: 'ADM013', adminName: 'Sameer Joshi', publisherId: 'PUB007', publisherName: 'DLF Cyber Hub Screen', city: 'Gurgaon', radius: 5, status: 'Suspended', impressions: 32000, clicks: 960, revenue: 15000, date: '2026-01-05', hourlyBreakdown: generateHourlyData(960, 32000) },
  { id: 'AD024', title: 'Local Bakery - Morning Deals', type: 'Thumbnail', adminId: 'ADM020', adminName: 'Shweta Mishra', publisherId: 'PUB019', publisherName: 'Community Center', city: 'Kolkata', radius: 2, status: 'Active', impressions: 8000, clicks: 160, revenue: 1200, date: '2026-04-13', hourlyBreakdown: generateHourlyData(160, 8000) },
  { id: 'AD025', title: 'Yoga Retreat Workshop', type: 'Video', adminId: 'ADM019', adminName: 'Deepak Kumar', publisherId: 'PUB010', publisherName: 'Goa Beach Resort', city: 'Goa', radius: 5, status: 'Active', impressions: 11000, clicks: 550, revenue: 4400, date: '2026-04-01', hourlyBreakdown: generateHourlyData(550, 11000) },
  { id: 'AD026', title: 'Furniture Clearance', type: 'Banner', adminId: 'ADM016', adminName: 'Tanvi Shah', publisherId: 'PUB009', publisherName: 'Phoenix Marketcity', city: 'Chennai', radius: 10, status: 'Expired', impressions: 48000, clicks: 1440, revenue: 12000, date: '2026-03-01', hourlyBreakdown: generateHourlyData(1440, 48000) },
  { id: 'AD027', title: 'Mobile Repair Service', type: 'Thumbnail', adminId: 'ADM013', adminName: 'Sameer Joshi', publisherId: 'PUB016', publisherName: 'Zudio Store Entrance', city: 'Ahmedabad', radius: 5, status: 'Active', impressions: 16000, clicks: 640, revenue: 3200, date: '2026-04-12', hourlyBreakdown: generateHourlyData(640, 16000) },
  { id: 'AD028', title: 'Coffee Shop - Work from Here', type: 'Banner', adminId: 'ADM004', adminName: 'Sneha Gupta', publisherId: 'PUB003', publisherName: 'Cafe Coffee Day - CP', city: 'Delhi', radius: 1, status: 'Draft', impressions: 0, clicks: 0, revenue: 0, date: '2026-04-14', hourlyBreakdown: generateHourlyData(0, 0) },
  { id: 'AD029', title: 'Public Service - Clean City', type: 'Video', adminId: 'ADM008', adminName: 'Neha Reddy', publisherId: 'PUB014', publisherName: 'Railway Station Platform 1', city: 'Bangalore', radius: 10, status: 'Active', impressions: 180000, clicks: 3600, revenue: 0, date: '2026-03-01', hourlyBreakdown: generateHourlyData(3600, 180000) },
  { id: 'AD030', title: 'New Restaurant Open', type: 'Banner', adminId: 'ADM011', adminName: 'Arjun Malhotra', publisherId: 'PUB015', publisherName: 'Bus Stand Digital Wall', city: 'Pune', radius: 5, status: 'Active', impressions: 22000, clicks: 660, revenue: 4400, date: '2026-04-14', hourlyBreakdown: generateHourlyData(660, 22000) },
  { id: 'AD031', title: 'Dental Clinic - Free Checkup', type: 'Thumbnail', adminId: 'ADM015', adminName: 'Manish Pandey', publisherId: 'PUB017', publisherName: 'Apartment Lift Panels', city: 'Noida', radius: 1, status: 'Active', impressions: 12000, clicks: 240, revenue: 2000, date: '2026-04-01', hourlyBreakdown: generateHourlyData(240, 12000) },
  { id: 'AD032', title: 'Jewelry Collection Launch', type: 'Banner', adminId: 'ADM001', adminName: 'Rahul Sharma', publisherId: 'PUB004', publisherName: 'PVR Cinemas Juhu', city: 'Mumbai', radius: 5, status: 'Expired', impressions: 35000, clicks: 1050, revenue: 12000, date: '2026-03-10', hourlyBreakdown: generateHourlyData(1050, 35000) },
  { id: 'AD033', title: 'Stock Trading Masterclass', type: 'Video', adminId: 'ADM016', adminName: 'Tanvi Shah', publisherId: 'PUB018', publisherName: 'Tech Park Entrance', city: 'Bangalore', radius: 5, status: 'Active', impressions: 42000, clicks: 1680, revenue: 15000, date: '2026-04-11', hourlyBreakdown: generateHourlyData(1680, 42000) },
  { id: 'AD034', title: 'Local Festival - Cultural Night', type: 'Banner', adminId: 'ADM020', adminName: 'Shweta Mishra', publisherId: 'PUB019', publisherName: 'Community Center', city: 'Kolkata', radius: 5, status: 'Suspended', impressions: 5000, clicks: 100, revenue: 500, date: '2026-03-01', hourlyBreakdown: generateHourlyData(100, 5000) },
  { id: 'AD035', title: 'Pet Grooming Service', type: 'Thumbnail', adminId: 'ADM001', adminName: 'Rahul Sharma', publisherId: 'PUB001', publisherName: 'City Mall Display', city: 'Mumbai', radius: 2, status: 'Active', impressions: 1200, clicks: 36, revenue: 500, date: '2026-04-14', hourlyBreakdown: generateHourlyData(36, 1200) },
  { id: 'AD036', title: 'Luxury Resort - Early Summer', type: 'Video', adminId: 'ADM019', adminName: 'Deepak Kumar', publisherId: 'PUB025', publisherName: 'Boutique Hotel Lobby', city: 'Udaipur', radius: 10, status: 'Active', impressions: 4500, clicks: 225, revenue: 3000, date: '2026-04-13', hourlyBreakdown: generateHourlyData(225, 4500) },
  { id: 'AD037', title: 'Auto Expo 2024', type: 'Banner', adminId: 'ADM013', adminName: 'Sameer Joshi', publisherId: 'PUB007', publisherName: 'DLF Cyber Hub Screen', city: 'Gurgaon', radius: 10, status: 'Expired', impressions: 85000, clicks: 2550, revenue: 20000, date: '2026-02-15', hourlyBreakdown: generateHourlyData(2550, 85000) },
  { id: 'AD038', title: 'Fashion Clearance - 70% Off', type: 'Thumbnail', adminId: 'ADM016', adminName: 'Tanvi Shah', publisherId: 'PUB009', publisherName: 'Phoenix Marketcity', city: 'Chennai', radius: 5, status: 'Active', impressions: 15000, clicks: 600, revenue: 4500, date: '2026-04-14', hourlyBreakdown: generateHourlyData(600, 15000) },
  { id: 'AD039', title: 'Home Insurance Plan', type: 'Video', adminId: 'ADM015', adminName: 'Manish Pandey', publisherId: 'PUB017', publisherName: 'Apartment Lift Panels', city: 'Noida', radius: 1, status: 'Active', impressions: 28000, clicks: 840, revenue: 10000, date: '2026-04-12', hourlyBreakdown: generateHourlyData(840, 28000) },
  { id: 'AD040', title: 'Street Food Festival', type: 'Banner', adminId: 'ADM001', adminName: 'Rahul Sharma', publisherId: 'PUB020', publisherName: 'HyperCity Lobby', city: 'Mumbai', radius: 5, status: 'Active', impressions: 12000, clicks: 360, revenue: 3600, date: '2026-04-14', hourlyBreakdown: generateHourlyData(360, 12000) },
];
