          ...
          {profileOpen && (
            <div className="absolute right-0 top-14 w-60 card-floating animate-fade-in-scale p-2 z-[51]">
              ...
              <div className="space-y-1">
                <button className="w-full flex items-center gap-3 px-4 py-3 text-xs font-black text-slate-600 hover:bg-slate-50 hover:text-slate-900 rounded-xl transition-all">
