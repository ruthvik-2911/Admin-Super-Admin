    ...
    <div className="space-y-6 pb-6 max-w-5xl mx-auto scroll-animate delay-75">
      ...
      <div className="flex items-center justify-between pt-1">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Manage your identity and view your activity log.</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="glass-card overflow-hidden">
            ...
            <div className="px-6 pb-6 pt-14 relative">
              <div className="w-20 h-20 bg-white dark:bg-[#1A1D24] rounded-full p-1.5 absolute -top-10 shadow-sm border border-gray-100 dark:border-gray-800">
                <div className="w-full h-full bg-primary-100 dark:bg-primary-900/40 text-primary-600 dark:text-primary-400 rounded-full flex items-center justify-center font-bold text-2xl">
                  SA
                </div>
              </div>
              ...
              <div className="mt-6 space-y-4">
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 dark:text-gray-200 font-medium">System Operator</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <div className="w-8 h-8 rounded-full bg-gray-50 dark:bg-gray-800 flex items-center justify-center text-gray-500 dark:text-gray-400">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 dark:text-gray-200 font-medium">admin@keliri.com</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <div className="w-8 h-8 rounded-full bg-gray-50 dark:bg-gray-800 flex items-center justify-center text-gray-500 dark:text-gray-400">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 dark:text-gray-200 font-medium">Super Administrator</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <div className="w-8 h-8 rounded-full bg-gray-50 dark:bg-gray-800 flex items-center justify-center text-gray-500 dark:text-gray-400">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 dark:text-gray-200 font-medium">01 January 2026</p>
                  </div>
                </div>
              </div>
          ...
          <div className="glass-card p-4 space-y-3">
            <button 
              ...
              className="w-full flex items-center justify-center gap-2 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 px-4 py-2.5 rounded-xl text-sm font-medium transition-colors border border-gray-200 dark:border-gray-700"
            >
              <Edit3 size={15} /> Edit Profile Info
            </button>
            <button 
              onClick={() => setShowChangePassword(true)}
              className="w-full flex items-center justify-center gap-2 bg-primary-50 dark:bg-primary-900/40 hover:bg-primary-100 dark:hover:bg-primary-900/60 text-primary-600 dark:text-primary-400 px-4 py-2.5 rounded-xl text-sm font-medium transition-colors border border-primary-100 dark:border-primary-500/30"
            >
        ...
        <div className="lg:col-span-2">
          <div className="glass-card p-6 h-full flex flex-col">
            ...
            <div className="relative pl-4 space-y-6 mt-2 flex-1">
              <div className="absolute left-6 top-2 bottom-0 w-px bg-gray-100 dark:bg-gray-800" />
              {activityLog.map((log) => (
                <div key={log.id} className="relative z-10 flex gap-4">
                  <div className="w-4 h-4 mt-1 rounded-full bg-primary-100 dark:bg-primary-900/40 border-2 border-white dark:border-[#1A1D24] flex-shrink-0 relative">
            ...
            <div className="mt-8 pt-4 border-t border-gray-50 dark:border-gray-800 flex justify-center">
              <button className="text-xs font-medium text-gray-500 dark:text-gray-600 hover:text-gray-800 dark:hover:text-gray-400 transition-colors">
      ...
      {showEditProfile && createPortal(
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-0">
          ...
          <div className="relative bg-white dark:bg-[#1A1D24] border border-gray-100 dark:border-gray-800 rounded-3xl shadow-xl w-full max-w-md overflow-hidden animate-fade-in" style={{ animationDuration: '0.2s' }}>
            <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">Edit Profile Info</h3>
              <button onClick={() => setShowEditProfile(false)} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 bg-gray-50 dark:bg-gray-800 rounded-full p-1.5 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                <X size={18} />
              </button>
            </div>
            <div className="p-6 space-y-5">
              ...
              <div className="space-y-2">
                <label className="text-xs font-semibold text-gray-700 dark:text-gray-300">Email Address <span className="font-normal text-gray-400 dark:text-gray-500">(Cannot be changed manually)</span></label>
                <input type="email" defaultValue="admin@keliri.com" readOnly className="input-field bg-gray-50 dark:bg-gray-800/80 opacity-70 cursor-not-allowed select-none" />
              </div>
            </div>
            <div className="px-6 py-4 bg-gray-50/50 dark:bg-gray-900/20 border-t border-gray-100 dark:border-gray-800 flex justify-end gap-3">
              <button 
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-0">
          ...
          <div className="relative bg-white dark:bg-[#1A1D24] border border-gray-100 dark:border-gray-800 rounded-3xl shadow-xl w-full max-w-md overflow-hidden animate-fade-in" style={{ animationDuration: '0.2s' }}>
            <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
              ...
              <button onClick={() => setShowChangePassword(false)} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 bg-gray-50 dark:bg-gray-800 rounded-full p-1.5 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                <X size={18} />
              </button>
            </div>
            <div className="p-6 space-y-5">
